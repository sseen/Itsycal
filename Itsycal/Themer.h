...
@property (nonatomic, readonly) NSColor *currentMonthWeekEndText;
@property (nonatomic, readonly) NSColor *DOWTextColor;
@property (nonatomic, readonly) NSColor *DOWWeekEndTextColor;
@property (nonatomic, readonly) NSColor *lunarTextColor;
@property (nonatomic, readonly) NSColor *lunarWeekEndTextColor;
...
@property (nonatomic, readonly) NSColor *todayCellOutlineColor;
